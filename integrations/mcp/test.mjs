...
test("MCP transport contains no database or service-role path", async () => {
  ...
  assert.deepEqual(Object.keys(definitions).sort(), ["attach_asset", "complete_mission", "create_location", "create_lore", "create_mission", "create_mission_encounter", "create_npc", "delete_mission", "delete_mission_encounter", "get_entity", "get_map", "get_mission", "link_mission_resource", "list_mission_encounters", "reopen_mission", "replace_encounter_monsters", "search_lore", "search_maps", "search_missions", "set_mission_status", "set_status", "update_entity", "update_mission", "update_mission_encounter", "upload_asset", "upload_entity_image", "upload_map"]);
});
