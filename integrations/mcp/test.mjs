...
test("MCP transport contains no database or service-role path", async () => {
  ...
  assert.deepEqual(Object.keys(definitions).sort(), ["attach_asset", "create_location", "create_lore", "create_npc", "get_entity", "get_map", "search_lore", "search_maps", "set_status", "update_entity", "upload_asset", "upload_entity_image", "upload_map"]);
});
