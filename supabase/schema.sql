...
-- AI capability preview lab: audit server-only per testo, regole e immagini.
...
COMMENT ON TABLE public.ai_preview_test_runs IS 'Audit server-only del laboratorio Admin AI: testo, regole e immagini; nessun chunk o binario immagine.';
COMMENT ON COLUMN public.ai_preview_test_runs.sources IS 'Riferimenti e metadati delle fonti, mai contenuto dei chunk.';
COMMENT ON COLUMN public.ai_preview_test_runs.output_ref IS 'Riferimento/metadati sicuri dell output non testuale; mai payload binario o data URL.';
