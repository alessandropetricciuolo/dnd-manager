    ...
    floors: [
      {
        ...
        walls: [],
        layers: [{ id: "layer-1", label: "Base", sortOrder: 0, presetId: "classic_hatching", opacity: 1, visible: true, areas: [{ id: "area-a", kind: "room", polygon: rectangleAreaPolygon(100, 100, 200, 150) }], walls: [] }],
      ...
      floors: [
        {
          ...
          layers: [{ id: "layer-1", label: "Base", sortOrder: 0, presetId: "classic_hatching", opacity: 1, visible: true, areas: [{ id: "area-1", kind: "room", polygon: rectangleAreaPolygon(0, 0, 100, 100) }], walls: [{ id: "wall-1", x1: 0, y1: 0, x2: 100, y2: 0 }] }],
          activeLayerId: "layer-1",
