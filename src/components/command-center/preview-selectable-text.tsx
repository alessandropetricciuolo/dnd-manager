...
export function PreviewSelectableText({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative", active && "rounded-md ring-1 ring-barber-gold/50")}
      onMouseUp={handleMouseUp}
    >
      <p
        className={cn(
          "whitespace-pre-wrap text-sm leading-relaxed text-barber-paper/90 selection:bg-barber-gold/35 selection:text-barber-paper",
