    ...
    <>
      <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        <div className="space-y-2">
              ...
              >
                <div className="space-y-2">
                  {isAdmin && adminDraftsEnabled ? <label className="flex items-center gap-2 rounded-md border border-violet-500/30 bg-violet-500/10 p-3 text-sm"><input type="checkbox" checked={adminOnly} onChange={(e) => setAdminOnly(e.target.checked)} disabled={isLoading} /> Solo Admin</label> : null}
