...
export type AiAssistantArtifactStatus = "draft" | "ready_for_review" | "approved" | "saved" | "discarded" | "failed";
...
export type AiAssistantThread = { id: string; ownerUserId: string; campaignId: string | null; mode: "v2_pilot"; status: "active" | "archived"; stateVersion: number; summary: string | null; };
